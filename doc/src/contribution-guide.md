...
You can get started with Lavender by following [the development guide on the repository](https://github.com/stoatchat/for-web?tab=readme-ov-file#development-guide).

## Contribution Policy

Since this project is still heavily in development, things may change rapidly at little notice, so it's recommended that you join [the Upryzing server](https://stt.gg/Testers) and [the Upryzing development server](https://stt.gg/API) where you can talk in `#Lavender` about this project.
